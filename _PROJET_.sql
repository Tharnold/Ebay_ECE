...
INSERT INTO `obj` (`ID`, `nom`, `comment`, `prix`, `categorie`) VALUES
(1, 'Fleur bleu', 'magnifique bijou', 25000, 3),
(2, 'vase antique', 'un vase datant de l\'Egypte ancienne d\'une rarete eblouissante ! A ne pas enlever de sa protecton de verre. ', 100000, 3),
(3, 'paire de sneaker 92\'', 'une paire de sneaker nike air Jordan 92\', jamais utlisé !\r\n\r\nObjet qui est rester dans ma collection donc vraiment sans aucune egratinure.', 356, 1),
(4, 'micro-onde', 'petit micro onde, peu utilise. \r\n\r\nPouvant decongeler des aliments, ce ami vous servira dans vos moments les plus durs.', 100, 1);
--
-- Database: `test`
--
...
--
-- Table structure for table `acheteuracompte`
--

DROP TABLE IF EXISTS `acheteuracompte`;
CREATE TABLE IF NOT EXISTS `acheteuracompte` (
  `nom` varchar(255) NOT NULL,
  `prenom` varchar(255) NOT NULL,
  `email` varchar(320) CHARACTER SET ascii NOT NULL,
  `NP` varchar(255) NOT NULL,
  `adressel1` char(60) NOT NULL,
  `adressel2` char(60) NOT NULL,
  `ville` char(60) NOT NULL,
  `codeP` char(10) CHARACTER SET ascii NOT NULL,
  `pays` char(60) NOT NULL,
  `numTel` text NOT NULL,
  `typeCarte` varchar(255) NOT NULL,
  `numeroCarte` char(30) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `nomCarte` varchar(255) NOT NULL,
  `dateExpi` date NOT NULL,
  `codeSecu` char(10) CHARACTER SET ascii NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `acheteuracompte`
--

INSERT INTO `acheteuracompte` (`nom`, `prenom`, `email`, `NP`, `adressel1`, `adressel2`, `ville`, `codeP`, `pays`, `numTel`, `typeCarte`, `numeroCarte`, `nomCarte`, `dateExpi`, `codeSecu`) VALUES
('Segretinat', 'Mathieu', 'segretinat.mathieu@edu.ece.fr', 'Mathieu Segretinat', '37, quai de Grenelle', '', 'Paris', '75015', 'France', '0674524163', 'MasterCard', '5123 6985 5874 5123', 'MATHIEU SEGRETINAT', '2000-01-22', '500');
...
CREATE TABLE IF NOT EXISTS `vendeur` (
  ...
  `email` varchar(320) CHARACTER SET ascii NOT NULL,
  `numeroTel` text CHARACTER SET ascii NOT NULL,
  `photo` text CHARACTER SET ascii COLLATE ascii_bin NOT NULL
...
INSERT INTO `vendeur` (`pseudo`, `nom`, `prenom`, `email`, `numeroTel`, `photo`) VALUES
('JacheteTout', 'Arnold', 'Thibault', 'Thibault.arnold@edu.ece.fr', '0611334455', '');
COMMIT;
